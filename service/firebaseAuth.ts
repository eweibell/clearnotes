...
export const handleSignUp = async (email: string, password: string, setLoading: (loading: boolean) => void) => {
...
export const handleLogIn = async (email: string, password: string, setLoading: (loading: boolean) => void) => {
...
export const useGoogleSignIn = () => {
  ...
  const androidClientId =
    __DEV__
      ? expoConfig?.extra?.GOOGLE_ANDROID_CLIENT_ID_DEBUG
      : expoConfig?.extra?.GOOGLE_ANDROID_CLIENT_ID_RELEASE;
  if (!androidClientId) {
